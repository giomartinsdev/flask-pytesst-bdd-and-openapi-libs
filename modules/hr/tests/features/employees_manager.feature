Feature: Assign managers
  ...
  Scenario: Successfully assign a LEAD as manager
    ...
    And an employee exists with name "Bob" email "bob@corp.com" department "Eng" role "LEAD" salary 12000
  ...
  Scenario: Cannot assign a manager below LEAD level
    Given an employee exists with name "Alice" email "alice@corp.com" department "Eng" role "JUNIOR" salary 5000
    And an employee exists with name "Bob" email "bob@corp.com" department "Eng" role "SENIOR" salary 9000
    When I assign manager "bob@corp.com" to employee "alice@corp.com"
